...
import com.trtc.uikit.livekit.voiceroom.interaction.connection.CoHostInviteAdapter
import com.trtc.uikit.livekit.voiceroom.interaction.connection.CrossRoomSessionView
...
class CrossRoomInteractionDialog(context: Context) : PopupDialog(context) ,
    ...
    private val liveListStore: LiveListStore
    ...
    private lateinit var inConnectionOrPKView: CrossRoomSessionView
    ...
    private fun initView() {
        rootView = LayoutInflater.from(context)
            .inflate(R.layout.livekit_voiceroom_cross_room_interaction_panel, null)
        bindViewId(rootView)
        initTabView()
        initRefresh()
    ...
    private fun createTab(tabLayout: TabLayout, titleRes: Int, colorRes: Int): TabLayout.Tab {
        ...
        val tabView = LayoutInflater.from(context)
            .inflate(R.layout.livekit_voiceroom_cross_room_interaction_view, null) as TextView

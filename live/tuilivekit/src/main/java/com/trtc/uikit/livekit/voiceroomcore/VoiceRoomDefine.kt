...
object VoiceRoomDefine {
    ...
    interface CoHostViewAdapter {
        fun createOccupiedSeatView(
            seatInfo: SeatInfo,
            isMyRoom: Boolean,
        ): View

        fun createAvailableSeatView(seatInfo: SeatInfo): View

        fun createRemoteSeatPlaceholderView(seatInfo: SeatInfo): View
    }
}
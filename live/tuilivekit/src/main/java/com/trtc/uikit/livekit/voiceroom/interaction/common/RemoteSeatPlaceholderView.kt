...
class RemoteSeatPlaceholderView @JvmOverloads constructor(
    context: Context,
    ...
    private fun initView() {
        LayoutInflater.from(context).inflate(R.layout.livekit_voiceroom_remote_seat_placeholder_view, this, true)
